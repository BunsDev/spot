...
describe("PerpetualTranche", function () {
  ...
  describe("#rollover", function () {
    describe("when trancheIn and trancheOut are the same", function () {
      it("should revert", async function () {
        await expect(
          perp.rollover(rotationInTranche.address, rotationInTranche.address, toFixedPtAmt("500")),
        ).to.revertedWith("Expected trancheIn and trancheOut NOT be the same");
      });
    });
